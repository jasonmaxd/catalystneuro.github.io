...
permalink: /
hidden: true
title: "<span style='text-align: center; font-family: Arial Narrow, sans-serif; margin-bottom: 10px; font-weight: normal;'>CATALYST</span><br><span style='text-align: center; font-family: Arial, sans-serif;'>NEURO</span>"
header:
