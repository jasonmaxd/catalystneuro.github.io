...
<header class="header" style="position: relative;">
  <div class="header-overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(94, 97, 108, 0.7);"></div>
  <div class="header-content" style="position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; text-align: center; color: #ffffff;">
    ...
    <div class="contact-info" style="margin-top: 2rem;">
      ...
      <p style="margin-top: 0.5rem;">844 Rose Drive, <br> Benicia, CA 94510</p>
